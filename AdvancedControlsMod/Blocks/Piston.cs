...
namespace Lench.AdvancedControls.Blocks
{
    ...
    public class Piston : Block
    {
        ...
        /// <summary>
        ///     Analog input for piston extension.
        ///     0 for fully compressed, 1 for fully extended.
        /// </summary>
        public float Extension
        {
            get { return (_sc.posToBe - _defaultStartLimit) / (_defaultNewLimit - _defaultStartLimit); }
