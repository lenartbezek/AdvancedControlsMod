...
namespace Lench.AdvancedControls
{
    ...
    public class PythonEnvironment
    {
        ...
        public PythonEnvironment(object scope = null, bool redirectOutput = true)
        {
            ...
            Execute("from UnityEngine import Vector2, Vector3, Vector4, Quaternion, Mathf, Time, Input, KeyCode, Color");

            Execute("clr.AddReference(\"AdvancedControlsMod\")");
            Execute("from Lench.AdvancedControls import Machine as machine");
        ...
        /// </summary>
        public static string LibPath => $"{Application.dataPath}/Mods/Resources/AdvancedControls/lib/{Version}/";
        ...
        {
            get { return _getVariableMethod.Invoke(_scope, new object[] {key}); }
            set { _setVariableMethod.Invoke(_scope, new[] {key, value}); }
        }
        ...
        public static void AddInitStatement(string expression)
        {
            ...
            OnInitialization += python =>
            {
                ...
                {
                    Debug.Log(
                        $"<b><color=#FF0000>Python error during initialization statement:\n{e.Message}</color></b>\n{FormatException(e)}");
                }
            };
        }
